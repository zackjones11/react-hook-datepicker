...
const getDatesInMonth = (date) => {
    ...
    return [...Array(daysInMonth)].map((_, i) => setDate(date, i + 1));
};
...
const useDatepicker = (props) => {
    const [selectedDate, setSelectedDate] = react.exports.useState(props === null || props === void 0 ? void 0 : props.currentDate);
    const [visibleDate, setVisibleDate] = react.exports.useState((props === null || props === void 0 ? void 0 : props.currentDate) || new Date());
    const [hoveredDate, setHoveredDate] = react.exports.useState();
    ...
    const getNextMonthButtonProps = () => {
        const nextVisibleDate = addMonths(visibleDate, 1);
        return {
            onClick: () => setVisibleDate(nextVisibleDate),
        };
    };
    const getPrevMonthButtonProps = () => {
        const nextVisibleDate = subMonths(visibleDate, 1);
        return {
            onClick: () => setVisibleDate(nextVisibleDate),
        };
    };
...
const useDateRangePicker = (props) => {
    var _a, _b;
    const [visibleRange, setVisibleRange] = react.exports.useState({
        start: ((_a = props === null || props === void 0 ? void 0 : props.currentRange) === null || _a === void 0 ? void 0 : _a.start) || new Date(),
        end: addMonth(((_b = props === null || props === void 0 ? void 0 : props.currentRange) === null || _b === void 0 ? void 0 : _b.end) || new Date()),
    });
    const [selectedRange, setSelectedRange] = react.exports.useState(props === null || props === void 0 ? void 0 : props.currentRange);
    const [hoveredRange, setHoveredRange] = react.exports.useState();
    const handleDateHovered = (date) => {
        setHoveredRange({ start: selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.start, end: date });
    };
    const handleDateClicked = (date) => {
        const isAfterStartDate = isAfterDate(date, selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.start);
        const stateKey = isAfterStartDate ? "end" : "start";
        const nextRange = Object.assign(Object.assign({}, selectedRange), { [stateKey]: date });
        setHoveredRange(nextRange);
        setSelectedRange(nextRange);
    };
    const getDateProps = ({ date }) => {
        const isSelected = isSameDate(selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.start, date) ||
            isSameDate(selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.end, date);
        const isInRange = isBeforeDate((selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.start) || (hoveredRange === null || hoveredRange === void 0 ? void 0 : hoveredRange.start), date) &&
            isAfterDate((selectedRange === null || selectedRange === void 0 ? void 0 : selectedRange.end) || (hoveredRange === null || hoveredRange === void 0 ? void 0 : hoveredRange.end), date);
        const isHovered = isSameDate(hoveredRange === null || hoveredRange === void 0 ? void 0 : hoveredRange.end, date);
        return {
